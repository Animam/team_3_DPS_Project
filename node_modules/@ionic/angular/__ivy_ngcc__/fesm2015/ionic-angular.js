...
IonTabs.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: IonTabs, selectors: [["ion-tabs"]], contentQueries: function IonTabs_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵviewQuery(_c1, 1, IonRouterOutlet);
    } if (rf & 2) {
        let _t;
...
IonVirtualScroll.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: IonVirtualScroll, selectors: [["ion-virtual-scroll"]], contentQueries: function IonVirtualScroll_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, VirtualItem, 1);
        ɵngcc0.ɵɵcontentQuery(dirIndex, VirtualHeader, 1);
        ɵngcc0.ɵɵcontentQuery(dirIndex, VirtualFooter, 1);
    } if (rf & 2) {
        let _t;
...
IonicModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [AngularDelegate, ModalController, PopoverController], imports: [[CommonModule]] });
